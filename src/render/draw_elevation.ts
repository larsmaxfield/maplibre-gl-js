...
export function drawElevation(painter: Painter, sourceCache: SourceCache, layer: ElevationStyleLayer, tileIDs: Array<OverscaledTileID>) {
    ...
    for (const coord of coords) {
        ...
        if (typeof tile.needsHillshadePrepare !== 'undefined' && tile.needsHillshadePrepare && painter.renderPass === 'offscreen') {
            prepareElevation(painter, tile, layer, depthMode, StencilMode.disabled, colorMode);
        } else if (painter.renderPass === 'translucent') {
            renderElevation(painter, coord, tile, layer, depthMode, stencilModes[coord.overscaledZ], colorMode);
        }
    }
